# Contributing to AnancyIO

Contributions to improve AnancyIO are very welcome!  This guide outlines how to contribute code, documentation, or other improvements.
...
1. **Fork the Repository:** Fork the AnancyIO repository on GitHub.
...
* **Code Style:** Follow the existing code style. AnancyIO generally follows PEP 8 conventions.
...
2. **Create a Pull Request:** Create a pull request from your branch to the appropriate branch in the main AnancyIO repository.
...
- The documentation is built using Markdown. We appreciate your contributions even if you don't know Markdown, and look forward to improve AnancyIO for everyone's benefit.