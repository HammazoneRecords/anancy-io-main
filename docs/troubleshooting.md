...
This page addresses frequently asked questions (FAQ) and provides troubleshooting steps for common issues encountered while using AnancyIO.

## Frequently Asked Questions
**1. How do I ask AnancyIO to work directly on my files or dirs?**
-   Place the files/dirs in the `work_dir` directory. AnancyIO will be able to perform tasks on them. The `work_dir` directory is located in the root directory of the Docker Container.
...
**3. How do I integrate open-source models with AnancyIO?**
...
**6. How can I make AnancyIO retain memory between sessions?**
Refer to the [How to update AnancyIO](installation.md#how-to-update-anancyio) section of the documentation for instructions on how to update AnancyIO while retaining memory and data.

**7. Where can I find more documentation or tutorials?**
-   Join the AnancyIO [Skool](https://www.skool.com/anancyio) or [Discord](https://discord.gg/B8KZKNsPpj) community for support and discussions.
...
**10. Can AnancyIO interact with external APIs or services (e.g., WhatsApp)?**
Extending AnancyIO to interact with external APIs is possible by creating custom tools or solutions. Refer to the documentation on creating them. 
...
* **Performance Issues:** If AnancyIO is slow or unresponsive, it might be due to resource limitations, network latency, or the complexity of your prompts and tasks, especially when using local models.