...
def print_troubleshooting():
    ...
    print("   - Make sure AnancyIO is running: python run_ui.py")
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                print("✅ AnancyIO server is running")
                return True
            except httpx.ConnectError:
                print("❌ Cannot connect to AnancyIO server")
...
def main():
    ...
    print("📋 Next Steps:")
    print("1. Start AnancyIO server if not running")
