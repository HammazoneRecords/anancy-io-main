...
def convert_out(settings: Settings) -> SettingsOutput:
    ...
    chat_model_fields.append(
        {
            ...
            "description": "Select provider for main chat model used by AnancyIO",
            "type": "select",
    ...
    chat_model_section: SettingsSection = {
        "id": "chat_model",
        "title": "Chat Model",
        "description": "Selection and settings for main chat model used by AnancyIO",
    ...
    browser_model_section: SettingsSection = {
        ...
        "description": "Settings for the web browser model. AnancyIO uses <a href='https://github.com/browser-use/browser-use' target='_blank'>browser-use</a> agentic framework to handle web interactions.",
    ...
    auth_section: SettingsSection = {
        ...
        "description": "Settings for authentication to use AnancyIO Web UI.",
        "fields": auth_fields,
        "tab": "external",
    }
    ...
    api_keys_section: SettingsSection = {
        "id": "api_keys",
        "title": "API Keys",
        "description": "API keys for model providers and services used by AnancyIO. You can set multiple API keys separated by a comma (,). They will be used in round-robin fashion.<br>For more information abou AnancyIO Venice provider, see <a href='http://anancyio.ai/?community/api-dashboard/about' target='_blank'>AnancyIO Venice</a>.",
    ...
    memory_fields.append(
        {
            ...
            "description": "AnancyIO will automatically recall memories based on convesation context.",
            "type": "switch",
    ...
    memory_fields.append(
        {
            ...
            "description": "The maximum number of memories to inject into A_IO's context window.",
            "type": "number",
    ...
    memory_fields.append(
        {
            ...
            "description": "The maximum number of solutions to inject into A_IO's context window.",
            "type": "number",
    ...
    memory_fields.append(
        {
            ...
            "description": "A_IO will automatically memorize facts and solutions from conversation history.",
            "type": "switch",
    ...
    memory_fields.append(
        {
            ...
            "description": "A_IO will automatically consolidate similar memories using utility LLM. Improves memory quality over time, adds 2 utility LLM calls per memory.",
            "type": "switch",
    ...
    memory_section: SettingsSection = {
        "id": "memory",
        "title": "Memory",
        "description": "Configuration of A_IO's memory system. A_IO memorizes and recalls memories automatically to help it's context awareness.",
    ...
    if runtime.is_development():
        ...
        #         "description": "Automatically create dockerized instance of A_IO for RFCs using this instance's code base and, settings and .env.",
        #         "type": "text",
        ...
        dev_fields.append(
            {
                ...
                "description": "URL of dockerized A_IO instance for remote function calls. Do not specify port here.",
                "type": "text",
        ...
        dev_fields.append(
            {
                "id": "rfc_port_http",
                "title": "RFC HTTP port",
                "description": "HTTP port for dockerized instance of A_IO.",
                "type": "text",
        ...
        dev_fields.append(
            {
                "id": "rfc_port_ssh",
                "title": "RFC SSH port",
                "description": "SSH port for dockerized instance of A_IO.",
                "type": "text",
    ...
    dev_section: SettingsSection = {
        "id": "dev",
        "title": "Development",
        "description": "Parameters for A_IO framework development. RFCs (remote function calls) are used to call functions on another A_IO instance. You can develop and debug A_IO natively on your local system while redirecting some functions to A_IO instance in docker. This is crucial for development as A_IO needs to run in standardized environment to support all features.",
        "fields": dev_fields,
        "tab": "developer",
    }
    ...
    mcp_client_section: SettingsSection = {
        ...
        "description": "AnancyIO can use external MCP servers, local or remote as tools.",
   ...
   # Secrets section
    ...
    mcp_server_fields.append(
        {
            ...
            "title": "Enable A_IO MCP Server",
            "description": "Expose AnancyIO as an SSE/HTTP MCP server. This will make this A_IO instance available to MCP clients.",
            "type": "switch",
    ...
    mcp_server_section: SettingsSection = {
        "id": "mcp_server",
        "title": "A_IO MCP Server",
        "description": "AnancyIO can be exposed as an SSE MCP server. See <a href=\"javascript:openModal('settings/mcp/server/example.html')\">connection example</a>.",
    ...
    a2a_fields.append(
        {
            ...
            "description": "Expose AnancyIO as A2A server. This allows other agents to connect to A_IO via A2A protocol.",
            "type": "switch",
    ...
    a2a_section: SettingsSection = {
        "id": "a2a_server",
        "title": "A_IO A2A Server",
        "description": "AnancyIO can be exposed as an A2A server. See <a href=\"javascript:openModal('settings/a2a/a2a-connection.html')\">connection example</a>.",
        "fields": a2a_fields,
        "tab": "mcp",
    }
    ...
    external_api_fields.append(
        {
            ...
            "title": "API Examples",
            "description": "View examples for using AnancyIO's external API endpoints with API key authentication.",
            "type": "button",
    ...
    external_api_section: SettingsSection = {
        "id": "external_api",
        "title": "External API",
        "description": "AnancyIO provides external API endpoints for integration with other applications. "
    ...
    update_checker_fields.append(
        {
            ...
            "description": "Enable update checker to notify about newer versions of AnancyIO.",
            "type": "switch",
    ...
    backup_section: SettingsSection = {
        ...
        "description": "Backup and restore AnancyIO data and configurations "
...
def _adjust_to_version(settings: Settings, default: Settings):
    # starting with 0.9, the default prompt subfolder for agent no. 0 is anancyio
    # switch to anancyio if the old default is used from v0.8
    if "version" not in settings or settings["version"].startswith("v0.8"):
        if "agent_profile" not in settings or settings["agent_profile"] == "default":
            settings["agent_profile"] = "anancyio"
