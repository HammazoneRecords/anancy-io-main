...
class AgentZeroWorker(Worker):  # type: ignore[misc]
    """AnancyIO implementation of FastA2A Worker."""
    ...
    async def run_task(self, params: Any) -> None:  # params: TaskSendParams
        """Execute a task by processing the message through AnancyIO."""
        context = None
        try:
            task_id = params['id']
            ...
            # Convert A2A message to AnancyIO format
            ...
            # Process message through AnancyIO (includes response)
    ...
    def _convert_message(self, a2a_message: Message) -> UserMessage:  # type: ignore
        """Convert A2A message to AnancyIO UserMessage."""
    ...
    def _configure(self):
        ...
        try:
            ...
            provider: AgentProvider = {  # type: ignore
                "organization": "AnancyIO",
                "url": "https://github.com/frdel/anancyio"
            }
