...
class EmailClient:
    ...
    async def read_messages(
        ...
        Args:
            download_folder: Folder to save attachments (relative to /a_io/)
    ...
    def _html_to_text(self, html_content: str, cid_map: Optional[Dict[str, str]] = None) -> str:
        ...
        Replaces inline images with [file:///a_io/...] markers to maintain
        positional context.
        """
        cid_map = cid_map or {}
    ...
    async def _save_attachment_bytes(
        ...
        Uses AnancyIO's file helpers for path management.
        """
        # Sanitize filename
