...
class BackupService:
    ...
    def __init__(self):
        ...
        self.base_paths = {
            self.anancy_io_root: self.anancy_io_root,
        }
    ...
    def get_default_backup_metadata(self) -> Dict[str, Any]:
        ...
        return {
            "backup_name": f"anancyio-backup-{timestamp[:10]}",
    ...
    def _get_default_patterns(self) -> str:
        ...
        Only includes AnancyIO project directory patterns.
        """
...
"""
    ...
    def _translate_patterns(self, patterns: List[str], backup_metadata: Dict[str, Any]) -> List[str]:
        ...
        Replaces the backed up AnancyIO root path with the current AnancyIO root path
        ...
        Args:
            ...
            backup_metadata: Backup metadata containing the original anancy_io_root

        Returns:
            List of translated patterns for the current system
        """
        # Get the backed up anancyio root path from metadata
        environment_info = backup_metadata.get("environment_info", {})
        backed_up_agent_root = environment_info.get("anancy_io_root", "")

        # Get current anancyio root path
        current_agent_root = self.anancy_io_root
        ...
        for pattern in patterns:
            # Check if the pattern starts with the backed up anancyio root
    ...
    async def create_backup(
        ...
        backup_name: str = "anancyio-backup"
    ) -> str:
        ...
        try:
            ...
            with zipfile.ZipFile(temp_file, 'r') as zipf:
                ...
                for archive_path in archive_files:
                    # Archive path is already the correct relative path (e.g., "a_io/tmp/settings.json")
                    ...
                    # so that patterns like "/home/rafael/a_io/data/**" can match files correctly
    ...
    def _translate_restore_path(self, archive_path: str, backup_metadata: Dict[str, Any]) -> str:
        ...
        # Check if the archive path starts with the backed up anancyio root
