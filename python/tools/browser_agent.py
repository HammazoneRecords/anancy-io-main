...
class BrowserAgent(Tool):
    ...
    async def execute(self, message="", reset="", **kwargs):
        ...
        message = get_secrets_manager(self.agent.context).mask_values(message, placeholder="<secret>{key}</secret>") # mask any potential passwords passed from A_IO to browser-use to browser-use format
