...
# check for newer versions of A_IO available and send notification
...
class UpdateCheck(Extension):
    ...
    def send_notification(self, notif):
        ...
        notifs.send_notification(
            ...
            message=notif.get("message", "A newer version of AnancyIO is available. Please update to the latest version."),
