...
class AgentContext:
    ...
    def __init__(
        ...
        self.anancyio = anancyio or Agent(0, self.config, self)
        self.paused = paused
    ...
    def reset(self):
        self.kill_process()
        self.log.reset()
        self.anancyio = Agent(0, self.config, self)
    ...
    def get_agent(self):
        return self.streaming_agent or self.anancyio
...
class Agent:
    ...
    def __init__(
        ...
        # agent context
        self.context = context or AgentContext(config=config, anancyio=self)
