    ...
    try {
      ...
      if (data.success && data.tunnel_url) {
        ...
        if (this.tunnelLink !== data.tunnel_url) {
          ...
          localStorage.setItem("anancy_io_tunnel_url", data.tunnel_url);
        }
        ...
        const storedTunnelUrl = localStorage.getItem("anancy_io_tunnel_url");
        ...
        if (storedTunnelUrl) {
          ...
          if (verifyData.success && verifyData.is_valid) {
            ...
            // Clear stale URL
            localStorage.removeItem("anancy_io_tunnel_url");
            this.tunnelLink = "";
    ...
    try {
      ...
      if (!hasAuth) {
        const proceed = confirm(
          "WARNING: No authentication is configured for your AnancyIO instance.\n\n" +
            "Creating a public tunnel without authentication means anyone with the URL " +
            "can access your AnancyIO instance.\n\n" +
